#How to Run This specific version
you have to have a local mongodb server, the config file is in src/server/config
you also have to be a developper in the facebook app beceause it relies on the facebook auth only
